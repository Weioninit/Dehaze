...
NameOri='C:\Users\振巍\Desktop\毕业论文figure\videodehaze\动态去雾\1.png';
NameResto='C:\Users\振巍\Desktop\毕业论文figure\videodehaze\动态去雾\vid_1.png';
NameResto1='C:\Users\振巍\Desktop\毕业论文figure\videodehaze\动态去雾\ori_1.png';
...
R1=imread(NameResto);
R1=double(R1);
R2=imread(NameResto1);
R2=double(R2);
% if the input image is a color image, use following line
R1=double(rgb2gray(uint8(R1)));
R2=double(rgb2gray(uint8(R2)));
[x,y]=size(R1);
[px,py] = gradient(I1);
[pxr,pyr] = gradient(R1);
[px2,py2] = gradient(R2);
